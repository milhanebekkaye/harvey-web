...
3. User answers the four questions on `/onboarding/questions`; on "Continue" after Q4 → PATCH `/api/user/onboarding` with all answers → redirect to `/onboarding/vision`.
